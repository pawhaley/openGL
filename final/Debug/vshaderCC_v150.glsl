...
void main()
{
	...
	TLightPosition=ModelView*LightPosition1;
	fL1 = TLightPosition.xyz;
	if( LightPosition1.w != 0.0 ) {
		fL1 = TLightPosition.xyz - tempPos.xyz;
	}


	TLightPosition=ModelView*LightPosition2;
	fL2 = TLightPosition.xyz;
	if( LightPosition2.w != 0.0 ) {
		fL2 = TLightPosition.xyz - tempPos.xyz;
	}



	TLightPosition=LightPosition3;
	fL3 = TLightPosition.xyz;
	if( LightPosition3.w != 0.0 ) {
		fL3 = TLightPosition.xyz - tempPos.xyz;
	}
